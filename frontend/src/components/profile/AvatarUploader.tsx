...
=======
        className="absolute -bottom-2 -right-2 size-9 rounded-full border border-white/70 bg-white text-primary shadow-md transition duration-300 hover:scale-105 hover:bg-white"
